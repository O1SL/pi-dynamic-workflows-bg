...
export function createWorkflowTool(options: WorkflowToolOptions = {}): ToolDefinition<typeof workflowToolSchema, any> {
  return defineTool({
    ...
    description: [
      ...
      "Follow-up lifecycle: workflow_extend starts a linked workflow from parent context; read the pi-dynamic-workflows-bg skill for replace_tail/resume details.",
      "Diagnostics and operations: read the pi-dynamic-workflows-bg skill for summary/events/transcript/worktrees/prune/steer guidance; those advanced tools are documented rather than exposed by default.",
