...
for (const name of ['workflow', 'workflow_status', 'workflow_result', 'workflow_transcript', 'workflow_worktrees', 'workflow_worktree_cleanup', 'workflow_resume', 'workflow_cancel', 'workflow_wait']) {
  if (!tools.has(name)) throw new Error(`${name} tool was not registered`);
}
for (const name of ['workflow-status', 'workflow-result', 'workflow-transcript', 'workflow-worktrees', 'workflow-worktree-cleanup', 'workflow-resume', 'workflow-cancel']) {
