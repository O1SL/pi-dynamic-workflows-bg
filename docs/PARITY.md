...
| Native management tools | Implemented | `workflow_status`, `workflow_result`, `workflow_summary`, `workflow_transcript`, `workflow_events`, `workflow_worktrees`, `workflow_worktree_cleanup`, `workflow_resume`, `workflow_cancel`, `workflow_wait`. Ambiguous id/prefix lookups report candidate run IDs instead of looking like missing runs. |
