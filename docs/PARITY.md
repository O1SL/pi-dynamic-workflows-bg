...
| Local QA | Implemented | `qa:full` covers manager, extension, batching, recovery, lazy disk run lookup, ambiguous prefix diagnostics, artifact pruning, live-owner reconciliation, artifacts, transcript, wait, cancel, failure, token budget, etc. |
